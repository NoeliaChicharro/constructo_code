...
import stylesCss from 'themes/constructo/styles.css?inline';
...
export const applyTheme = (target) => {
  ...
  if (!document['_vaadintheme_constructo_componentCss']) {
    
    document['_vaadintheme_constructo_componentCss'] = true;
  }
