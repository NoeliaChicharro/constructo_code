...
alter table class add constraint class_mainTeacherRefFk foreign key (mainTeacher) references constructo_user;
alter table class add constraint class_studentRefFk foreign key (student) references constructo_user;
