...
import ch.constructo.backend.data.profiler.RepositoryProfiler;
...
public class MasterDataPersistenceConfig extends BasePersistenceConfig{
  ...
  public DataSourceInitializer masterDataSourceInitializer(@Qualifier(Constants.CH_CONSTRUCTO_MASTER_DS) DataSource dataSource) {
